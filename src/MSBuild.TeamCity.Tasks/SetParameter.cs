...
namespace MSBuild.TeamCity.Tasks
{
    ...
    ///     </ul>
    ///     <p />
    ///     <a href="http://confluence.jetbrains.net/display/TCD7/Configuring+Build+Parameters">
    ///         Read more about build
    ///         parameters and their prefixes
    ///     </a>
    ...
    public class SetParameter : TeamCityTask
    {
        ...
        {
            yield return new SetParameterTeamCityMessage(this.Name, this.Value);
        }
    }
}