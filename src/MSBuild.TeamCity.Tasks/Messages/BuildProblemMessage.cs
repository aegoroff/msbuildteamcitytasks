...
namespace MSBuild.TeamCity.Tasks.Messages
{
    ...
    public class BuildProblemMessage : TeamCityMessage
    {
        ...
        ///     (mandatory) a human-readable plain text describing the build problem.
        ///     By default description appears in the build status text and in the list of build's problems.
        ///     Limited to 4000 symbols, will be truncated if exceeds.
        /// </param>
        /// <param name="identity">
        ...
        {
            this.Attributes.Add("description", description);
            if (!string.IsNullOrWhiteSpace(identity))
            {
                this.Attributes.Add("identity", identity);
            }
        }
        ...
        {
            [DebuggerStepThrough] get { return "buildProblem"; }
        }
    }
}