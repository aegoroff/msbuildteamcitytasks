...
namespace Tests
{
    ...
    public class TImportDataBuilder
    {
        ...
        [TestCase("bad", "##teamcity[importData type='dotNetCoverage' path='p' tool='partcover']", false, null, ImportType.DotNetCoverage, ExpectedException = typeof(NotSupportedException))]
