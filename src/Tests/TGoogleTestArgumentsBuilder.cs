...
namespace Tests
{
	...
	public class TGoogleTestArgumentsBuilder
	{
		...
		public void RunDisabledTestsAndCathcingExceptions()
		{
			...
			Assert.That(builder.CreateCommandLine(), Is.EqualTo(OutputXml + Space + DisableTestsCommand + Space + CatchExceptionsCommand));
		}
		...
		public void CathcingExceptionsAndFilter()
		{
			...
			Assert.That(builder.CreateCommandLine(), Is.EqualTo(OutputXml + Space + CatchExceptionsCommand + Space + FilterCommand));
		}
		...
		public void All()
		{
			...
			Assert.That(builder.CreateCommandLine(), Is.EqualTo(OutputXml + Space + DisableTestsCommand + Space + CatchExceptionsCommand + Space + FilterCommand));
		}
	}
}