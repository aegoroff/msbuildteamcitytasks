...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/TR/xhtml1/strict">
		...
		<html>
			...
			<body>
				...
				<table cellpadding="3" cellspacing="3" id="Module">
					<tr>
						<td><img src="Lib/fxcop-critical-error.gif" /> Critical Errors</td>
						<td><xsl:value-of select="count(//Issue[@Level='CriticalError'])" /></td>
					</tr>
					<tr>
						<td><img src="Lib/fxcop-error.gif" /> Errors</td>
						<td><xsl:value-of select="count(//Issue[@Level='Error'])" /></td>
					</tr>
					<tr>
						<td><img src="Lib/fxcop-critical-warning.gif" /> Critical Warnings</td>
						<td><xsl:value-of select="count(//Issue[@Level='CriticalWarning'])" /></td>
					</tr>
					<tr>
						<td><img src="Lib/fxcop-warning.gif" /> Warnings</td>
	...
	<xsl:template match="Module">
		...
		<table id="Text" cellspacing="0" cellpadding="3">
			<tr>
				<td width="150"><img src="Lib/fxcop-critical-error.gif" /> Critical Errors</td>
				<td bgcolor="#990000">
		...
		<table id="Text" cellspacing="0" cellpadding="3">
			<tr>
				<td width="150"><img src="Lib/fxcop-error.gif" /> Errors</td>
				<td bgcolor="#FF0000">
		...
		<table id="Text" cellspacing="0" cellpadding="3">
			<tr>
				<td width="150"><img src="Lib/fxcop-critical-warning.gif" /> Critical Warnings</td>
				<td bgcolor="#FF9900">
		...
		<table id="Text" cellspacing="0" cellpadding="3">
			<tr>
				<td width="150"><img src="Lib/fxcop-warning.gif" /> Warnings</td>
				<td bgcolor="#FFFF00">
