...
namespace MSBuild.TeamCity.Tasks.Messages
{
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="TestFinishTeamCityMessage" /> class using name and duration in seconds
        ///     specified
        /// </summary>
        ...
        public TestFinishTeamCityMessage(string name, double durationSeconds) : base(name)
        {
            ...
            this.Attributes.Add("duration", duration.ToString(CultureInfo.InvariantCulture));
        }
        ...
        {
            [DebuggerStepThrough] get { return "testFinished"; }
        }
    }
}