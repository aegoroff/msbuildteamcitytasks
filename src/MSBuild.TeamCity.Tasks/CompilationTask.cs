...
namespace MSBuild.TeamCity.Tasks
{
    ...
    public abstract class CompilationTask : TeamCityTask
    {
        ...
        {
            yield return new CompilationMessage(this.Compiler, this.CompilationMessage);
        }
    }
    ...
    /// </summary>
    /// <example>
    ///     Finishes reporting compilation messages
    ///     <code><![CDATA[
    ///  ...
    ...
    public class CompilationFinished : CompilationTask
    {
        ...
        ///     Gets the compliation message (start/finish)
        /// </summary>
        protected override string CompilationMessage => "compilationFinished";
    }
    ...
    /// </summary>
    /// <example>
    ///     Starts reporting compilation messages
    ///     <code><![CDATA[
    ...
    public class CompilationStarted : CompilationTask
    {
        ...
        {
            [DebuggerStepThrough] get { return "compilationStarted"; }
        }
    }
}