...
namespace MSBuild.TeamCity.Tasks
{
    ...
    ///     Optional CaptureStandardOutput boolean attribute can be present in the <see cref="TestStarted" /> service message
    ///     to
    ///     identify whether to include output received between <see cref="TestStarted" /> and <see cref="TestFinished" />
    ///     messages
    ...
    public class TestStarted : TeamCityTask
    {
        ...
        {
            yield return new TestStartTeamCityMessage(this.Name, this.CaptureStandardOutput);
        }
    }
}